...
import { Mail, Eye, EyeOff, Briefcase, ArrowRight, Loader2 } from "lucide-react";
  ...
  async function handleEmailSignIn(e: React.FormEvent) {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Let the server decide: /feed for onboarded users, /onboarding for new ones
      ...
      <div className="hidden lg:flex lg:w-1/2 profile-banner-gradient flex-col items-center justify-center p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-white/80 text-lg leading-relaxed">
            Connect with professionals, showcase your experience, and advance your career.
          </p>
